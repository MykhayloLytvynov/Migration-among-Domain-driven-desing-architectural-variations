// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AssertExtension.cs" company="BUT">
//   All rights reserved.
// </copyright>
// <summary>
//   The assert extenstion.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace Common.Testing.Utility.Extension
{
    using System;
    ...
    public static class AssertExtension
    {
        ...
        {
            FieldInfo[] fields = expected.GetType().GetFields(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
